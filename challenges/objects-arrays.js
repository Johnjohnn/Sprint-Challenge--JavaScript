...
const universities = [];
for (let student of graduates) universities.push(student.university);
...
const uni = [];
for (let student of graduates)
  if (/Uni/.test(student.university)) uni.push(student.university);
console.log(uni);
